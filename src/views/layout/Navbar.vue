<template>
    <el-menu class="navbar" mode="horizontal">
        ...
        <el-autocomplete v-model="state" :fetch-suggestions="querySearchAsync" placeholder="请输入内容" @select="handleSelect" icon="close" :on-icon-click="clearSelect" class="apin-search">
